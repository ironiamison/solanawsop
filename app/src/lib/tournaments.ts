...
export function getGrandOpeningTournament(): TournamentEvent {
  ...
  return {
    ...
    prizeHighlight: "1,000 USDC PRIZE",
    playersLabel: "—",
    status: "registering",
...
export const UPCOMING_TOURNAMENTS: TournamentEvent[] = [
  ...
  {
    id: "turbo-22",
    title: "Freeroll Turbo Sprint #22",
    subtitle: "Fast blinds · freeroll",
    buyInLabel: "FREE",
    prizePool: `500K ${TOKEN_SYMBOL}`,
    playersLabel: "—",
    status: "registering",
    startsIn: "2h 14m",
    tierIndex: 0,
